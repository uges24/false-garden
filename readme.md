...
**False Garden** is a light rebrand/remix of `momentchan/false-earth`, preserving the original WebGPU grass, terrain, character movement, camera modes, beams, and postprocessing as the technical foundation.



This branch exists to prove the direct False Earth base runs inside this repository before adding separate graphics-demo integrations. The visible palette and copy have been nudged toward emerald grass, gold light, and cyan-violet energy, while the underlying systems remain False Earth.

Original project: https://github.com/momentchan/false-earth
