            ...
            <div className='entry' style={entryContainerStyle}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p>
                            A false garden extends in every direction, emerald and unreal.
                            The grass keeps moving after each step, as if the field remembers.
                            A gold light hangs above it, watching the horizon breathe.
                        </p>

                        <p>
                            Move through the living field and let the terrain answer.
                            This is still the original False Earth foundation, lightly retuned into a garden.
                        </p>
{/* 
                        {!gpuError && (
                            <p>
